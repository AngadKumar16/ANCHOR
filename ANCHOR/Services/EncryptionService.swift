...
final class EncryptionService {
    ...
    private let keyTag = "com.anchor.symmetric.v1"
    ...
    private func getKey() -> SymmetricKey? {
        guard let d = KeychainHelper.shared.getKeyData(tag: keyTag) else { return nil }
    ...
    func encryptString(_ text: String) throws -> Data {
        ...
        guard let combined = sealed.combined else { throw NSError(domain: "EncryptionService", code: -1, userInfo: nil) }
        return combined
    }
