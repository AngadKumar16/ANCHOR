...
struct JournalEntryViewView: View {
    @StateObject private var vm = JournalEntryViewViewModel()
    @State private var draft: String = ""

    var body: some View {
        NavigationView {
            VStack {
                Text("JournalEntryView").font(.largeTitle)
...
#if DEBUG
struct JournalEntryViewView_Previews: PreviewProvider {
    static var previews: some View { JournalEntryViewView() }
}
#endif
