...
struct EmailpasswordLoginViewModelView: View {
    @StateObject private var vm = EmailpasswordLoginViewModelViewModel()
    @State private var draft: String = ""

    var body: some View {
        NavigationView {
            VStack {
                Text("EmailpasswordLoginViewModel").font(.largeTitle)
...
#if DEBUG
struct EmailpasswordLoginViewModelView_Previews: PreviewProvider {
    static var previews: some View { EmailpasswordLoginViewModelView() }
}
#endif
