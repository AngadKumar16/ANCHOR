...
/// Auto-generated ViewModel for 'Risk assessment system'
final class RiskAssessmentSystemViewModel: ObservableObject {
    @Published var title: String = "Risk assessment system"
