...
struct EntryCategorizationtaggingViewModelView: View {
    @StateObject private var vm = EntryCategorizationtaggingViewModelViewModel()
    @State private var draft: String = ""

    var body: some View {
        NavigationView {
            VStack {
                Text("EntryCategorizationtaggingViewModel").font(.largeTitle)
...
#if DEBUG
struct EntryCategorizationtaggingViewModelView_Previews: PreviewProvider {
    static var previews: some View { EntryCategorizationtaggingViewModelView() }
}
#endif
