...
struct ImplementUserAuthenticationServiceViewModelView: View {
    @StateObject private var vm = ImplementUserAuthenticationServiceViewModelViewModel()
    @State private var draft: String = ""

    var body: some View {
        NavigationView {
            VStack {
                Text("ImplementUserAuthenticationServiceViewModel").font(.largeTitle)
...
#if DEBUG
struct ImplementUserAuthenticationServiceViewModelView_Previews: PreviewProvider {
    static var previews: some View { ImplementUserAuthenticationServiceViewModelView() }
}
#endif
