...
struct InitialSyncImplementationViewModelView: View {
    @StateObject private var vm = InitialSyncImplementationViewModelViewModel()
    @State private var draft: String = ""

    var body: some View {
        NavigationView {
            VStack {
                Text("InitialSyncImplementationViewModel").font(.largeTitle)
...
#if DEBUG
struct InitialSyncImplementationViewModelView_Previews: PreviewProvider {
    static var previews: some View { InitialSyncImplementationViewModelView() }
}
#endif
