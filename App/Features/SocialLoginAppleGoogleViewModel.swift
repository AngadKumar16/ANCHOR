...
/// Auto-generated ViewModel for 'Social login (Apple, Google)'
final class SocialLoginAppleGoogleViewModel: ObservableObject {
    @Published var title: String = "Social login (Apple, Google)"
