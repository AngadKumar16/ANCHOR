...
/// Auto-generated ViewModel for 'Set up cloud sync (iCloud/Core Data)'
final class SetUpCloudSyncIcloudcoreDataViewModel: ObservableObject {
    @Published var title: String = "Set up cloud sync (iCloud/Core Data)"
